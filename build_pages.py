...
COMMON_FAQ = [
 ...
 ("Який мінімальний обсяг замовлення?",
  "Основний формат — серійні B2B-замовлення. Перед запуском серії можемо виготовити дослідний зразок "
  "або тестову партію для перевірки конструкції та погодження характеристик. Обсяг узгоджуємо "
  "індивідуально: він залежить від складності виробу, конфігурації та необхідності розроблення "
  "нової конструкції."),
...
PAGES["21700"] = dict(
 ...
 meta="Контрактне виробництво акумуляторних збірок на циліндричних елементах 21700 для FPV, БПЛА, "
      "систем РЕБ та роботизованих комплексів.",
 ...
 keys=[("500+","акумуляторів на день"),("B2B","серійні замовлення під ТЗ"),
...
<section class="sec sec-tight sec-ink" id="contacts">
  <div class="wrap">
    <div class="sechead">
      ...
      <p class="lead reveal d1">B2B, Україна. Серійні замовлення під технічне завдання, без роздрібного продажу.</p>
    </div>
