...
ORG = {
    ...
    "description": ("Контрактне виробництво літієвих акумуляторних збірок для FPV-дронів, БПЛА, "
                    ...
                    "серії від 100 шт., до 500+ акумуляторів на день."),
    "foundingDate": "2023",
    ...
    "makesOffer": {
        ...
        "eligibleQuantity": {"@type": "QuantitativeValue", "minValue": 100, "unitText": "шт."},
    },
}
...
- **Мінімальна партія:** від 100 акумуляторів. Перед серією — дослідний зразок або тестова партія.
